...
> En modell för hur CCTV, termisk övervakning, anti-tamper-placering och operativa incidentvyer kan integreras i en högsäker facilitymiljö.
...
| Status | Draft |
| Scope | CCTV, thermal surveillance, camera placement principles, anti-tamper logic, operator incident views |
...
## 6. Surveillance Should Follow Zone Logic
...
- upptäckt av personer nära fasad eller i yttre skuggzoner
...
> Övervakning ska inte bara se vad som händer runt byggnaden, utan också bidra till att skydda själva övervakningssystemet och ge snabb, användbar situationsförståelse när något faktiskt händer.
